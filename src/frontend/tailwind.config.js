    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          approved: "oklch(var(--approved))",
          rejected: "oklch(var(--rejected))",
        },
        chart: {
          1: "oklch(var(--chart-1))",
          2: "oklch(var(--chart-2))",
      ...
      boxShadow: {
        ...
        gold: "0 0 20px oklch(0.74 0.16 68 / 0.3), 0 0 40px oklch(0.74 0.16 68 / 0.1)",
        "gold-sm": "0 0 10px oklch(0.74 0.16 68 / 0.25)",
